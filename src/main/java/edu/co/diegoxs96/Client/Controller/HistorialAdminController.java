...
public class HistorialAdminController {
    ...
    private void conectar() {
        try {
            ...
            System.out.println("[HISTORIAL ADMIN] Sin conexión al servidor.");
        }
    }
    ...
    private void cargarDatos() {
        ...
        try {
            ArrayList<TicketDTO> tickets = service.listarTodosTickets();
            tablaHistorial.setItems(FXCollections.observableArrayList(tickets));
        } catch (Exception e) {
            System.out.println("[HISTORIAL ADMIN] Error al cargar datos: " + e.getMessage());
        }
    }
    ...
    @FXML private void handleVerCita()       { System.out.println("[HISTORIAL ADMIN] Ver cita — pendiente"); }
    @FXML private void handleModificarCita() { System.out.println("[HISTORIAL ADMIN] Modificar cita — pendiente"); }
    @FXML private void handleHistorial()     { System.out.println("[HISTORIAL ADMIN] Ya estás aquí"); }
